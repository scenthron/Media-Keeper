...
a = Analysis(
    ...
    hiddenimports=['PyQt6.QtSvg', 'PyQt6.QtSvgWidgets', 'PyQt6.QtMultimedia', 'PyQt6.QtMultimediaWidgets', 'PyQt6.sip', 'PIL', 'numpy', 'cv2', 'onnxruntime', 'backports', 'backports.tarfile', 'jaraco', 'jaraco.text', 'jaraco.functools', 'jaraco.context', 'pkg_resources', 'setuptools', 'modules.cleaner.vhash', 'modules.cleaner.ahash_audio', 'modules.cleaner.ui_ai_results_tree', 'modules.cleaner.ui_ai_references_panel', 'modules.cleaner.logic_ai_classifier', 'modules.cleaner.logic_ai_cache', 'modules.cleaner.logic_ai', 'modules.cleaner.ai_facade'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
